...
const population = 8655280;

const capital = "Belgrade";

const officialLanguage = "Serbian";

const currency = "Serbian dinar";

const flagImageUrl =
  "https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Flag_of_Serbia_%282004%E2%80%932010%29.svg/800px-Flag_of_Serbia_%282004%E2%80%932010%29.svg.png?20220821195250";

const history = `The history of Serbia covers the historical development of Serbia and of its predecessor states, from the Early Stone Age to the present state, as well as that of the Serbian people and of the areas they ruled historically. The scope of Serbian habitation and rule has varied much through the ages, and, as a result, the history of Serbia is similarly elastic in what it includes.
